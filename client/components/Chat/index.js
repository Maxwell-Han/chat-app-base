...
import { getMessages, addMessage } from "../../store";
    ...
    return (
      <Container>
        <Row>
          ...
          <Container>
            {numbMessages > 0 ?
              Object.keys(messages).map(mId => <MessageCard key={mId} text={messages[mId].content} />) : null}
          </Container>
        </Row>
        <Row form>
          <Form onSubmit={this.handleAddMessage}>
            <FormGroup>
              ...
              <FormTextarea name="content" onChange={this.handleChange} value={this.state.content} />
